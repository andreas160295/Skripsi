...
echo "<h1 style=text-align:left>Kesaksian</h1>";
...
?>
	...
	<?php echo $data;?>
 	...
 	<a href="index.php?menu=detail_kesaksian&id=<?=$tampil['id_berita'];?>"> <br /> <p style='text-align:right'> Selengkapnya </p> </a>
...
$total_pages= ceil($total_results / $max_results);
	...
	if($hal > 1)
		{ 
			$prev=($page - 1);
			echo "<a href=$_SERVER[PHP_SELF]?menu=kesaksian&hal=$prev><-Sebelumnya</a>";
		}
	...
	for($i=1; $i<=$total_pages; $i++)
		{
			...
			{
				echo "<a href=$_SERVER[PHP_SELF]?menu=kesaksian&hal=$i>$i</a>";
			}
		}
			...
			{
				$next=($page + 1);
				echo "<a href=$_SERVER[PHP_SELF]?menu=kesaksian&hal=$next>Selanjutnya-></a>";
			}
	echo"</center>";
