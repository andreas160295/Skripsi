...
echo "<h1 style=text-align:left>Pesan Pastor</h1>";
...
?>
	...
	<?php echo $data;?>
 	...
 	<a href="index.php?menu=detail_pesan_pastor&id=<?=$tampil['id_berita'];?>"><br /><p align="right">Selengkapnya</p></a>
...
$total_pages= ceil($total_results / $max_results);
	...
	if($hal > 1)
		{ 
			$prev=($page - 1);
			echo "<a href=$_SERVER[PHP_SELF]?menu=pesan_pastor&hal=$prev><-Sebelumnya</a>";
		}
	...
	for($i=1; $i<=$total_pages; $i++)
		{
			...
			{
				echo "<a href=$_SERVER[PHP_SELF]?menu=pesan_pastor&hal=$i>$i</a>";
			}
		}
			...
			{
				$next=($page + 1);
				echo "<a href=$_SERVER[PHP_SELF]?menu=pesan_pastor&hal=$next>Selanjutnya-></a>";
			}
	echo"</center>";
